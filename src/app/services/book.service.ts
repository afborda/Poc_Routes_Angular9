  ...
  constructor() {
    timer(2000).subscribe(() =>
      this.bookSubject$.next([
        { title: 'book1', pages: 100, authors: ['Joao'] },
        { title: 'book2', pages: 200, authors: ['Abner2'] },
        { title: 'book3', pages: 300, authors: ['Abner3', 'Cris'] },
        { title: 'book4', pages: 400, authors: ['Abner4'] },
        { title: 'book5', pages: 500, authors: ['Abner5', 'Cris'] },
        { title: 'book6', pages: 600, authors: ['Abner6'] },
        { title: 'book7', pages: 200, authors: ['Abner7', 'Cris'] },
        { title: 'book8', pages: 300, authors: ['Abner8'] },
        { title: 'book9', pages: 200, authors: ['Abner9'] },
